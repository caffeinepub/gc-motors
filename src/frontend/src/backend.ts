...
import type { CarBrand as _CarBrand } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getAllCarBrands(): Promise<Array<CarBrand>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCarBrands();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCarBrandByName(arg0: string): Promise<CarBrand | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCarBrandByName(arg0);
    ...
    async getGameFeatures(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGameFeatures();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPartnerInfo(): Promise<PartnerInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getPartnerInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReleaseDate(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getReleaseDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CarBrand]): CarBrand | null {
